...
\begin{tipblock}
\cmaj{2.8.1} L'idée est de proposer un environnement pour travailler sur des intervalles :
...
\begin{itemize}
	...
	%\item \Cle{Coeff=1.1
	\item \Cle{Valeurs} : valeurs à afficher sous l'axe ;
...
Les deux arguments obligatoires, et entre \ctex{\{...\}}, permettent de préciser les bornes de l'intervalle (avec \ctex{*} pour l'infini.)
\end{cautionblock}
...
{\small \bverb|v 2.8.1|~:~~~~Environnement et commande pour travailler sur avec des intervalles (page \pageref{intervalles})}

{\small \bverb|v 2.8.0|~:~~~~Amélioration du tapis de Sierpinski (page \pageref{fractales})}
